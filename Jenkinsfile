    ...
    stages{
        ...
        stage("Publish to ansible server"){
            steps{
                ...
                transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'unzip ansible-${BUILD_ID}; rm -rf ansible-${BUILD_ID}', execTimeout: 120000, flatten: false, makeEmptyDirs: false, \
